...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /*Memastikan bahwa nlai email dan password sesuai dengan nilai yang tersimpan*/
  if (email == expectedEmail && password == expectedPassword) {
    
    /*Jika sesuai makan program akan berpindah ke halaman home*/
    goToHome();
    
  } else {
    /*Namun jika tidak sesuai makan akan menampilkan informasi bahwa input salah*/
    showPopUp();
  }
});
